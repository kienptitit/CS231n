...
class CaptioningRNN:
    ...
    def loss(self, features, captions):
        ...
        h0,cache_affine = affine_forward(features,self.params['W_proj'],self.params['b_proj']) # [N,D]

        word_embedding,cache_embedding = word_embedding_forward(captions,self.params['W_embed']) # [N,T,D]
        ...
        dx,d_Wproj,d_bproj = affine_backward(dh0,cache_affine)
